    ...
    <section id="about" class="py-16 bg-gray-100">
        <div class="container mx-auto px-4">
            ...
            <div class="text-center mb-10">
                <h1 class="text-3xl md:text-4xl font-bold text-gray-800">About Us</h1>
                <p class="text-gray-600 mt-4 max-w-2xl mx-auto">
                    Welcome to <span class="font-semibold text-blue-600">Phone Haven</span>, your ultimate destination
                    for premium smartphones, accessories, and expert service.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="flex justify-center">
                    <img src="https://via.placeholder.com/500x300" alt="About Phone Store"
                ...
                <div>
                    ...
                    <p class="text-gray-600 mb-6">
                        At <span class="font-semibold text-blue-600">Phone Haven</span>, we are passionate about
                        bringing you the latest in mobile technology. With years of experience, we’ve built a reputation
                        for providing high-quality products and excellent customer service.
                    </p>
                    <h3 class="text-xl font-semibold text-gray-800 mb-2">Our Mission</h3>
                    <p class="text-gray-600">
                        To connect people with cutting-edge smartphones and accessories that enhance their lives.
                        Whether you're looking for the latest flagship phone or reliable repair services, we’ve got you
                        covered.
                    </p>
                </div>
            </div>
            ...
            <!-- Services Section -->
            <div class="mt-16">
                <h2 class="text-2xl font-bold text-center text-gray-800 mb-10">Why Choose Us?</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="text-center bg-white shadow-lg p-6 rounded-lg">
                        <svg class="w-12 h-12 mx-auto text-blue-500 mb-4">
                            <use xlink:href="#cart-outline" />
                        </svg>
                        <h3 class="text-lg font-bold text-gray-800 mb-2">Wide Selection</h3>
                        <p class="text-gray-600">Explore the latest smartphones and accessories from top brands.</p>
                    </div>
                    <div class="text-center bg-white shadow-lg p-6 rounded-lg">
                        <svg class="w-12 h-12 mx-auto text-green-500 mb-4">
                            <use xlink:href="#shield-plus" />
                        </svg>
                        <h3 class="text-lg font-bold text-gray-800 mb-2">Secure Payment</h3>
                        <p class="text-gray-600">Enjoy hassle-free and 100% secure payment options.</p>
                    </div>
                    <div class="text-center bg-white shadow-lg p-6 rounded-lg">
                        <svg class="w-12 h-12 mx-auto text-yellow-500 mb-4">
                            <use xlink:href="#price-tag" />
                        </svg>
                        <h3 class="text-lg font-bold text-gray-800 mb-2">Affordable Prices</h3>
                        <p class="text-gray-600">Get the best deals on the latest mobile gadgets.</p>
                    </div>
                    <div class="text-center bg-white shadow-lg p-6 rounded-lg">
                        <svg class="w-12 h-12 mx-auto text-red-500 mb-4">
                            <use xlink:href="#quality" />
                        </svg>
                        <h3 class="text-lg font-bold text-gray-800 mb-2">Expert Support</h3>
                        <p class="text-gray-600">Our team is here to guide you in making the right choice.</p>
                    </div>
                </div>
            </div>
        </div>
